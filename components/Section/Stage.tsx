...
import SpiralGallery from '../Package/SpiralGallery.tsx';
...
const Stage: React.FC<StageProps> = ({ 
  ...
  return (
    <div style={{ 
        ...
        alignItems: 'center', 
        justifyContent: 'center', 
        padding: (btnProps.componentType === 'slot' || btnProps.componentType === 'spiral') ? '0px' : '80px',
        perspective: '1000px',
        width: '100%',
        height: '100%',
    }}>
        <motion.div 
            style={{ 
                position: 'relative', 
                display: (btnProps.componentType === 'slot' || btnProps.componentType === 'spiral') ? 'block' : 'inline-block',
                width: (btnProps.componentType === 'slot' || btnProps.componentType === 'spiral') ? '100%' : 'auto',
                height: (btnProps.componentType === 'slot' || btnProps.componentType === 'spiral') ? '100%' : 'auto',
        ...
        >
            ...
            ) : btnProps.componentType === 'spiral' ? (
                <SpiralGallery ref={componentRef} />
            ) : (
