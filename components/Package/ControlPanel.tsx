        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: theme.space['Space.L'] }}>
          <Select<any>
            ...
            onChange={(e) => onPropChange({ 
                 ...
                 */
                customRadius: e.target.value === 'nametag' ? theme.radius['Radius.L'] : e.target.value === 'card' ? '40px' : (e.target.value === 'slot' || e.target.value === 'spiral') ? '0px' : e.target.value === 'custom' ? theme.radius['Radius.M'] : theme.height['Height.L'],
            ...
            options={[
              ...
              { value: 'spiral', label: 'Spiral Gallery (3D)' },
            ]}
          />
